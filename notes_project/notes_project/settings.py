...
SECRET_KEY = 'django-insecure-o2ljk9qohr9l8rv11wpr9a=#^wpd3d40v35d!sqq#j(h4_q9!*'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'dbsql',  # Change to your MySQL database name
        'USER': 'root',  # Change to your MySQL username
        'PASSWORD': 'Dhasa2218*',  # Change to your MySQL password
